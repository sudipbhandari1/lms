...
<form action="publisher_function.php" method="post">
    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-4">
            ...
            <div class="input-group">
                ...
                <input class="form-control" name="ID" type="text" placeholder="publisher ID"
                       required="required">
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="input-group">
                ...
                <input class="form-control" name="publisher_name" type="text" placeholder="publisher name"
                       required="required">
            </div>
    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-4">
            ...
            <div class="input-group">
                ...
                <input class="form-control" name="DoB" type="date" min="2012-01-01" max="2013-01-01" type="date"
